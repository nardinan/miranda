...
void p_exception_fill(struct s_exception exception, const char *message, const char *file, const char *function, unsigned int line) {
	...
	strncpy(v_exception_raised.description, message, d_exception_description_size);
	strncpy(v_exception_raised.file, file, d_exception_file_size);
	strncpy(v_exception_raised.function, function, d_exception_description_size);
