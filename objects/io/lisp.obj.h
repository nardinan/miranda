...
#define d_lisp_cddr(obj) (d_lisp_cdr(d_lisp_cdr(obj)))
#define d_lisp_caddr(obj) (d_lisp_car(d_lisp_cdr(d_lisp_cdr(obj))))
#define d_lisp_cdddr(obj) (d_lisp_cdr(d_lisp_cdr(d_lisp_cdr(obj))))
#define d_lisp_is_string(obj) ((obj)&&(obj->type==e_lisp_object_type_string))
#define d_lisp_is_value(obj) ((obj)&&(obj->type==e_lisp_object_type_value))
#define d_lisp_is_symbol(obj) ((obj)&&(obj->type==e_lisp_object_type_symbol))
#define d_lisp_is_primitive(obj) ((obj)&&(obj->type==e_lisp_object_type_primitive))
