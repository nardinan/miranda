...
typedef enum e_media_factory_media_types {
    ...
    e_media_factory_media_type_track,
...
d_declare_method(media_factory, get_json)(struct s_object *self, const char *label);
d_declare_method(media_factory, get_script)(struct s_object *self, const char *label);
