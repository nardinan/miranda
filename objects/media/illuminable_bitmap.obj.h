...
typedef enum e_illuminable_bitmap_axis {
  e_illuminable_bitmap_axis_x = 0,
  e_illuminable_bitmap_axis_y
} e_illuminable_bitmap_axis;
d_declare_class(illuminable_bitmap) {
  struct s_attributes head;
  struct s_object *drawable_mask[e_illuminable_bitmap_side_NULL];
  struct s_object *lights;
  enum e_illuminable_bitmap_axis main_axis;
