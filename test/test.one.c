...
int main (int argc, char *argv[]) {
	s_object *string_one, *string_two, *string_three, *string_four;
	f_memory_init();
	...
	f_object_delete(string_one);
	f_object_delete(string_two);
	f_object_delete(string_three);
	f_object_delete(string_four);
	f_memory_destroy();
	return 0;
}
